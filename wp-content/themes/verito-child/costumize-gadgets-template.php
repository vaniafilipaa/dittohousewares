<?php
/* Template name: Costumize Gadgets with handles template */
get_header();
        ...
        <div class="row">
            ...
            <div class="col-sm-9 col-xs-12 pro-grid">
                ...
                <div id="servingTools" class="col-xs-12">
                    ...
                    foreach ($subcats as $key => $sc) {
                        echo '<div class="slick-container-'.$sc->term_id.' slick-container hidden">';
      ...
      <div class="modal-body">
        <form>
            ...
            <fieldset class="form-group">
                ...
                <div class="form-group row">
                    <label for="references" class="col-sm-4 col-form-label">Reference(s)</label>
                    <div class="col-sm-5">
...
jQuery(function ($) {
    ...
    function createSlick(elID){
        ...
        $('.slick-container-' + elID).removeClass('hidden').addClass('active');
    ...
    $("#sortByCollection").change(function () {
        $('#servingToolsSlick .slick-container').addClass('hidden');
        activeCollectionID = this.value;
        createSlick(activeCollectionID);
    });

    $("#sortByType").change(function () {
        $('#handlesSlick .slick-container').addClass('hidden');
